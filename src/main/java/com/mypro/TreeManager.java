...
import com.mypro.entity.TreeNode;
...
public class TreeManager {
	...
	public static void main(String[] args) {
		...
		node3.setLabel("子节点4");
		node3.setValue(20);
		node3.setMultiValues(new double[]{2, 5, 8});
		node3.setChildrenMultiValues(new ArrayList<double[]>());
		node3.setPid(3);
		list1.add(node3);
       ...
       System.out.println(treeListMultiValues);
//
...
//        System.out.println("tree转List 汇总多个值values完成");
		...
		Map<Long, Object> leafList = null;
     TreeManager.findMinNodes(tree,leafList);
